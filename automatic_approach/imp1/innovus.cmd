...
#  Created on Wed May 18 12:44:51 2022                
#                                                     
#######################################################
...
getIoFlowFlag
setIoFlowFlag 0
floorPlan -coreMarginsBy die -site tsm3site -s 80 80 10 10 10 10
uiSetTool select
getIoFlowFlag
fit
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix Adder_postRoute -outDir timingReports
...
create_constraint_mode -name constraints1 -sdc_files {../syn1/constraints.sdc}
...
set_analysis_view -setup {typical} -hold {typical}
set init_abstract_view abstract
set init_verilog ../syn1/adder1.v
init_design
update_constraint_mode -name constraints1 -sdc_files {../syn1/constraints1.sdc}
set_analysis_view -setup {typical} -hold {typical}
redirect -quiet {set honorDomain [getAnalysisMode -honorClockDomains]} > /dev/null
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix Adder_postRoute -outDir timingReports
report_timing
...
create_library_set -name typical -timing {typical.lib}
create_library_set -name slow -timing {slow.lib}
create_constraint_mode -name constraints1 -sdc_files {../syn1/constraints1.sdc}
create_delay_corner -name fast -library_set {fast}
create_delay_corner -name slow -library_set {slow}
create_delay_corner -name typical -library_set {typical}
create_analysis_view -name typical -constraint_mode {constraints1} -delay_corner {typical}
...
timeDesign -postRoute -pathReports -drvReports -slackReports -numPaths 50 -prefix Adder_postRoute -outDir timingReports
report_timing
selectWire 55.5800 64.5800 55.8600 99.9150 2 {B[6]}
create_library_set -name fast -timing {fast.lib}
create_library_set -name typical -timing {typical.lib}
create_library_set -name slow -timing {slow.lib}
create_constraint_mode -name constraints1 -sdc_files {../syn1/constraints1.sdc}
